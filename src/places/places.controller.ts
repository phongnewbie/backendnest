...
export class PlacesController {
  ...
  async create(
    ...
    return await this.placesService.create(createPlaceDto, userId);
  }
  ...
  async update(
    ...
    return await this.placesService.update(id, updatePlaceDto, userId);
  }
  ...
  async remove(@Param('id') id: string, @GetUserId() userId: string) {
    return await this.placesService.remove(id, userId);
  }
}
